...
graph TB
    subgraph INPACT["<b>INPACTâ„¢ Framework</b><br/>Six Agent Needs for User Trust"]
        ...
        T["<b>T - Transparent</b><br/>Transparency Builds Confidence<br/>100% audit trails + citations"]
    end
...
| **T** - Transparent | ___/6 | ___/6 | ___/6 | ___/6 | 5-6/6 |
...
**Healthcare Example:**
- **Critical:** P (Permitted - HIPAA compliance), T (Transparent - audit trails)
...
- T (Transparent): 4/6 - Audit logs 100% coverage Ã¢Å“â€¦
...
- **T (Transparent):** Are audit logs still capturing 100%? (Logging gaps?)
...
**Critical Needs:** P (Permitted), T (Transparent) - HIPAA compliance non-negotiable

**Target Scores:**
- P (Permitted): 6/6 (ABAC + HITL for all clinical decisions)
- T (Transparent): 6/6 (100% audit trails, full reasoning traces)
...
graph TD
    subgraph INPACT["<b>INPACTâ„¢ Needs</b>"]
        ...
        T["<b>T - Transparent</b><br/>Transparency"]
    end
...
**Black Box:** Agent that doesn't explain decisions or show sources (opposite of Transparent)
...
**Transparent:** Transparency through audit trails, citations, and reasoning traces (vs black box)
